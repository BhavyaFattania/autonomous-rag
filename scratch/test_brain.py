...
async def test_brain():
    ...
    state = {
        ...
        "successful_patterns": ["High top_k increases recall", "Hierarchical chunking works better for long docs"],
    ...
    artifacts_dir = Path(r"C:\Users\BHAVYA\.gemini\antigravity-ide\brain\e113d92a-fdef-4f35-80aa-9315ce93acdf")
